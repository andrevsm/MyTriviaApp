...
import com.avsm.android.navigation.databinding.FragmentGameWonBinding
    ...
    override fun onCreateView(
        ...
        binding.nextMatchButton.setOnClickListener { v: View ->
            v.findNavController().navigate(
                GameWonFragmentDirections.actionGameWonFragment2ToGameFragment()
            )
        }
